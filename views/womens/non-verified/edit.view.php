        ...
        <fieldset class="mx-lg-5 my-lg-3 inline-form">
            <div class="row">
                <div class=" col-lg-4 col-sm-6 form-floating mb-3">
                    <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="<?= $women['last_name'] ?>" autocomplete="off" required>
                ...
                <div class=" col-lg-4 col-sm-6 form-floating mb-3">
                    <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="<?= $women['first_name'] ?>" autocomplete="off" required>
