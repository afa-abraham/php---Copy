...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $stmt = $conn -> prepare("INSERT INTO clients (fname,lname,age,location,height,weight,interested,body_type,hair_color,eyes_color,ethnicity,marital_status,smoking,drinking,religion,education,children,no_of_children,employment,description,idealMatch,additional_comments) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    if($stmt === false) {
    ...
    $stmt -> bind_param("ssissssssssssssssissss", $fname,$lname, $age, $location, $height, $weight, $interested, $body_type, $hair_color,$eyes_color,$ethnicity,$marital_status,$smoking,$drinking,$religion,$education,$children,$no_of_children,$employment,$description,$idealMatch,$additional_comments);
