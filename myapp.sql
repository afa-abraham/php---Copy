...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2024 at 11:59 AM
...
-- Database: `m3db`
--
CREATE DATABASE IF NOT EXISTS `m3db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `m3db`;
...
INSERT INTO `t_city` (`id`, `country_id`, `city_name`, `status`, `ludatetime`) VALUES
(1, 1, 'Chongquing', 'A', '2024-05-22 07:47:45'),
(2, 1, 'Shenyang', 'A', '2024-05-22 07:47:45'),
(3, 1, 'Shenzhen', 'A', '2024-05-22 07:47:45'),
(4, 1, 'Hongkong', 'A', '2024-05-22 07:47:45'),
(5, 2, 'Bangkok', 'A', '2024-05-22 07:47:45'),
(6, 3, 'Cebu', 'A', '2024-05-22 07:47:45'),
(7, 3, 'Davao', 'A', '2024-05-22 07:47:45');
...
INSERT INTO `t_country` (`id`, `country_name`, `status`, `ludatetime`) VALUES
(1, 'China', 'A', '2024-05-22 07:47:18'),
(2, 'Thailand', 'A', '2024-05-22 07:47:18'),
(3, 'Philippines', 'A', '2024-05-22 07:47:18'),
(4, 'test', 'A', '0000-00-00 00:00:00');
...
ALTER TABLE `t_city`
  ADD PRIMARY KEY (`id`),
  ADD KEY `city to country fk` (`country_id`);
...
--
ALTER TABLE `t_city`
  ADD CONSTRAINT `city to country fk` FOREIGN KEY (`country_id`) REFERENCES `t_country` (`id`);
--
-- Database: `m3db_v2`
--
CREATE DATABASE IF NOT EXISTS `m3db_v2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `m3db_v2`;
...
INSERT INTO `gmail_users` (`id`, `uid`, `name`, `email`, `locale`, `picture`, `gmail_status`, `ludatetime`) VALUES
(3, '103068019036821471734', 'John Ranel', 'afacebu.john@gmail.com', '', 'https://lh3.googleusercontent.com/a/ACg8ocKynaabcymceuRTF5_7lg4JCZmI5nGQ9-6OkqTXGdoHbzCIFms=s96-c', 'Y', '2024-07-05 13:03:39'),
(4, '104783673896006372375', 'Abraham Sulit', 'afacebu.abraham@gmail.com', '', 'https://lh3.googleusercontent.com/a/ACg8ocKoq1yFERgQnI5axELfS4_1c0S4sa1aSL2Wd2UgHvXBb1V8fx0=s96-c', 'Y', '2024-07-09 22:04:06');
...
--
-- Indexes for table `gmail_users`
--
ALTER TABLE `gmail_users`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `gmail_users`
--
ALTER TABLE `gmail_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
CREATE DATABASE IF NOT EXISTS `mailing_system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mailing_system`;
...
INSERT INTO `mails` (`id`, `sender_id`, `receiver_id`, `subject`, `body`, `sent_at`, `sender_deleted`, `receiver_deleted`, `is_read`, `archived`, `sender_archived`, `receiver_archived`) VALUES
(13, 11, 7, 'message to Isabella', 'this is a message from admin', '2024-07-12 11:02:22', 1, 0, 0, 0, 0, 0),
(14, 7, 11, 'Re: message to Isabella', 'hi admin', '2024-07-12 11:09:24', 0, 1, 1, 0, 0, 0),
(16, 11, 7, 'delete email after sending', 'for delete should stay in receivers end ', '2024-07-12 11:26:12', 1, 0, 0, 0, 0, 0),
(17, 11, 7, 'message using email', 'message using email', '2024-07-12 11:29:30', 0, 0, 1, 1, 0, 0),
(18, 7, 11, 'Re: message using email', 'reply message using email address ', '2024-07-12 11:31:09', 0, 1, 1, 1, 0, 0),
(19, 20, 19, 'message1', 'Message 1', '2024-07-12 15:46:16', 0, 0, 0, 0, 0, 0),
(20, 19, 20, 'Re: message1', 'Replied', '2024-07-12 15:46:59', 0, 1, 0, 0, 0, 0),
(21, 20, 19, 'hello', 'hello', '2024-07-12 15:50:57', 0, 0, 0, 0, 0, 0),
(22, 20, 19, 'hi', 'hi', '2024-07-12 15:51:10', 0, 0, 0, 0, 1, 0),
(23, 19, 20, 'helow', 'helow', '2024-07-12 15:53:54', 0, 0, 1, 0, 0, 1),
(24, 21, 19, 'Hi Moderator', 'Please Accept my registration', '2024-07-15 07:35:41', 0, 0, 0, 0, 0, 0),
(25, 19, 21, 'Re: Hi Moderator', 'accepted', '2024-07-15 07:36:57', 0, 0, 0, 0, 0, 0),
(26, 21, 19, 'Re: Re: Hi Moderator', 'Thanks', '2024-07-15 07:39:15', 0, 0, 0, 0, 0, 0),
(27, 11, 7, 'test for read status', 'read status', '2024-07-15 09:30:28', 1, 0, 1, 0, 0, 0),
(28, 7, 11, 'Re: test for read status', 'this is read', '2024-07-15 09:31:00', 0, 1, 0, 1, 0, 0),
(29, 7, 11, 'Re: test for read status', 'awdawd', '2024-07-15 09:41:55', 0, 1, 1, 1, 0, 0),
(30, 19, 20, 'Hellow Fernzds', 'lorem .....', '2024-07-15 11:52:31', 0, 0, 1, 1, 0, 0),
(31, 11, 20, '123', '123', '2024-07-16 07:57:57', 1, 1, 0, 0, 0, 0),
(32, 11, 20, '1231231231', '123123123', '2024-07-16 08:00:07', 1, 1, 0, 0, 0, 0),
(33, 11, 20, '12314sfdfdsfds', 'sadsassadsad', '2024-07-16 08:01:11', 1, 0, 0, 1, 0, 0),
(34, 11, 20, '123fsafsafsaghghhcxvsdfse', 'asdfasdasdgajkfhjklsdhgjkdfhgjk', '2024-07-16 08:04:12', 1, 1, 0, 0, 0, 0),
(35, 11, 7, 'Re: Re: test for read status', 'rfsefse', '2024-07-16 08:22:10', 0, 0, 0, 1, 0, 0),
(36, 20, 11, 'wadawdawdawd', 'awdawdawd', '2024-07-16 08:23:03', 0, 1, 1, 1, 0, 0),
(37, 11, 20, 'Re: wadawdawdawd', 'wadawd', '2024-07-16 09:08:07', 0, 0, 1, 1, 0, 0),
(38, 11, 21, 'hello', 'hello......', '2024-07-16 14:29:26', 1, 0, 1, 1, 0, 0),
(39, 21, 11, 'Re: hello', 'Received', '2024-07-16 14:30:47', 0, 1, 0, 0, 0, 0),
(40, 11, 21, 'to read', 'awdawd', '2024-07-16 14:43:16', 0, 0, 1, 1, 0, 0),
(41, 11, 21, 'to read part 2', 'ejdfsfekjsejhsklef\r\n', '2024-07-16 14:52:42', 0, 0, 1, 1, 0, 0),
(42, 20, 11, 'for archive', 'wadawdawdawda', '2024-07-17 07:48:38', 1, 1, 0, 1, 0, 0),
(43, 20, 11, 'afwwaf', 'awfawfawf', '2024-07-17 07:48:50', 0, 1, 0, 1, 0, 0),
(44, 20, 11, '12312312', 'fawawfawf', '2024-07-17 07:48:58', 0, 1, 0, 1, 0, 0),
(45, 20, 11, 'wdawdawd', 'awdawdawd', '2024-07-17 07:56:00', 0, 1, 0, 1, 0, 0),
(46, 20, 11, 'awdawdawd', 'awdawdawdawd', '2024-07-17 07:56:07', 0, 1, 0, 1, 0, 0),
(47, 20, 11, 'wadawdaw', 'awdawdawd', '2024-07-17 07:57:42', 0, 1, 0, 1, 0, 0),
(48, 11, 20, 'Re: wdawdawd', 'hellloooowowowowowowow', '2024-07-17 07:57:59', 1, 1, 1, 0, 0, 0),
(49, 20, 11, '12312', '1wqdqwdqwd', '2024-07-17 08:17:52', 0, 1, 0, 1, 0, 0),
(50, 20, 11, '12312312', '3123123123', '2024-07-17 08:17:57', 0, 1, 0, 1, 0, 0),
(51, 20, 11, '12312312', '3123123123', '2024-07-17 08:18:03', 1, 1, 0, 0, 0, 0),
(52, 11, 20, 'awdawd', 'awdawd', '2024-07-17 08:22:29', 1, 1, 0, 0, 0, 0),
(53, 11, 20, 'dawdawdaw', 'dawdawdawd', '2024-07-17 08:22:37', 1, 1, 0, 0, 0, 0),
(54, 11, 20, 'awdawd', 'awdawdawd', '2024-07-17 08:22:42', 1, 1, 0, 0, 0, 0),
(55, 11, 20, 'wdawawdawd', 'awdawd', '2024-07-17 08:22:49', 1, 0, 0, 1, 0, 0),
(56, 20, 11, 'wdawdawd', 'awdawd', '2024-07-17 08:23:18', 1, 1, 0, 0, 0, 0),
(57, 20, 11, 'Re: wdawawdawd', 'awdawdawdawd', '2024-07-17 08:24:07', 0, 1, 0, 1, 0, 0),
(58, 11, 20, 'awdawdaw', 'dawdawdawd', '2024-07-17 08:28:41', 1, 1, 1, 0, 0, 0),
(59, 11, 20, 'awdawdawd', 'awdawdawd', '2024-07-17 08:29:04', 1, 1, 0, 0, 0, 0),
(60, 11, 20, 'awdawdawd', 'awdawdawd', '2024-07-17 08:29:09', 1, 1, 0, 0, 0, 0),
(61, 11, 20, 'dawdawdaw', 'dawdawdawd', '2024-07-17 08:29:16', 1, 1, 0, 0, 0, 0),
(62, 11, 20, 'awdawdawd', 'awdawdawdawd', '2024-07-17 08:29:22', 0, 0, 0, 1, 0, 0),
(63, 20, 11, '123', 'wdadawdawd', '2024-07-17 08:39:13', 1, 1, 0, 0, 0, 0),
(64, 20, 11, 'wdawdawd', 'awdawdawdaw', '2024-07-17 08:39:23', 0, 0, 0, 1, 0, 0),
(65, 20, 11, 'wdawdaw', 'dawdawd', '2024-07-17 08:39:43', 0, 1, 0, 0, 1, 1),
(66, 11, 20, 'awdawda', 'wdawdawd', '2024-07-17 08:40:21', 0, 0, 0, 0, 1, 0),
(67, 11, 7, 'adawd', 'awdawdawd', '2024-07-17 08:41:15', 0, 0, 0, 1, 0, 0),
(68, 11, 7, 'awdawd', 'awdawdawdawd', '2024-07-17 08:41:25', 0, 0, 0, 0, 0, 0),
(69, 11, 7, 'awdawdawd', 'awdawdawd', '2024-07-17 08:41:32', 0, 0, 0, 0, 1, 0),
(70, 11, 7, 'awdawda', 'wdawdawd', '2024-07-17 08:51:16', 1, 0, 0, 0, 1, 0),
(71, 11, 20, 'dawdawd', 'awdawdawd', '2024-07-17 08:51:28', 1, 1, 0, 0, 0, 1),
(72, 11, 20, 'awdawdaw', 'dawdawd', '2024-07-17 08:51:34', 0, 1, 1, 0, 0, 1),
(73, 20, 11, 'Re: awdawdaw', 'awdawawd', '2024-07-17 08:54:57', 1, 1, 0, 0, 0, 1),
(74, 20, 11, 'awdawd', 'awdawd', '2024-07-17 09:00:55', 0, 0, 0, 0, 0, 0),
(75, 20, 11, 'wadawd', 'awdawdaw', '2024-07-17 09:01:05', 0, 0, 0, 0, 0, 1),
(76, 20, 11, 'awdawda', 'wdawd', '2024-07-17 09:01:10', 1, 0, 1, 0, 0, 1),
(77, 11, 19, 'Give me apple', 'Please give me apple', '2024-07-17 12:47:23', 0, 0, 0, 0, 0, 0);
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `role_id`, `created_at`, `profile_image`) VALUES
(7, 'Isabella', '$2y$10$sxRW6Bj.NHlCrgeSdFgfDuI3QmwP81fGQvEjnZsxR6C69XxxLsvWG', 'Isabella@gmail.com', 2, '2024-07-12 09:07:02', 'womanDP.webp'),
(11, 'afa_admin', '$2y$10$hzTdvoNT9sak/n1vw75WZemlFqCfpO7yh77XV7rWX5Ony6uMQrkzG', 'afa-admin@gmail.com', 1, '2024-07-12 10:57:10', 'admin.jpg'),
(19, 'moderator', '$2y$10$wLD0t1ozcBUmqbb3HJpQue3ULnos.ggH4riXZcF8s.UDexnmCjc/K', 'moderator@email.com', 1, '2024-07-12 15:44:40', 'dp.webp'),
(20, 'Fernanda', '$2y$10$MZxNCvVUw2Wmrmoj9C0veusVQ9XxPO9voHQv6iusqgvDi6WnJz8a.', 'fernanda@email.com', 2, '2024-07-12 15:45:23', 'dpgirl.png'),
(21, 'babygirl2001', '$2y$10$ZARUhpHoPdJQniOXZ.ICJu9OSMHBLfHgux8rk2Lu5XdxirZNCoURK', 'babygirl@gmail.com', 2, '2024-07-15 07:34:49', 'above-the-fold-thumbnail2.png');
...
CREATE TABLE `mails` (
  ...
  `sender_archived` tinyint(1) DEFAULT NULL,
  `receiver_archived` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `mail_users` (`id`, `username`, `password`, `email`, `role_id`, `created_at`, `profile_image`) VALUES
(1, 'maria_dabiana', '123456789', 'maria@dabiana.com', 2, '2024-07-18 12:28:35', 'default.png'),
(2, 'maria_delacruz', '123456789', 'maria@delacruz.com', 2, '2024-07-18 12:29:28', 'default.png');
...
(2, 'please see me now', 1),
(3, 'please see me now', 1),
(4, 'My note sample', 1);
...
(2, 'filo.sundae@gmail.com', '$2y$10$GU3EY0/6ZpsRrFvrJV2nf..BFqjPvCoF.qtfXOjJ9opWAeiH//Pqi'),
(3, 'michaelcorrs@gmail.com', '$2y$10$MdYNRYgzmiFkxqZgMz4B7u4p7E72FHBW7AXsdPTTmHgNfGdn8HW4G'),
(4, 'john@example.com', '$2y$10$Qi8wpL0uz2Aj1oBNPON.O..jn4jDppoXNa0CH4xSxg7Wz3YtBzhby'),
(5, 'mark@example.com', '$2y$10$/FJStP1fCbWHkmq8pzWJ3Ov8PM4aVn6HX0Sl3ZafFXigorGGLAsEy');
...
--
-- AUTO_INCREMENT for table `mail_users`
--
ALTER TABLE `mail_users`
...
--
ALTER TABLE `mails`
  ADD CONSTRAINT `mails_ibfk_1` FOREIGN KEY (`sender_id`) REFERENCES `mail_users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `mails_ibfk_2` FOREIGN KEY (`receiver_id`) REFERENCES `mail_users` (`id`) ON DELETE CASCADE;
--
-- Database: `mydb`
--
...
(1, 'John', 'Doe', 'john@example.com', '2024-07-09 11:42:41'),
(2, 'John', 'Doe', 'john@example.com', '2024-07-09 11:48:13'),
(4, 'John', 'Doe', 'john@example.com', '2024-07-09 12:05:19'),
(5, 'Mary', 'Moe', 'mary@example.com', '2024-07-09 12:05:19'),
(6, 'Julie', 'Dooley', 'julie@example.com', '2024-07-09 12:05:19'),
(7, 'John', 'Doe', 'john@example.com', '2024-07-09 12:15:40'),
(8, 'Mary', 'Moe', 'mary@example.com', '2024-07-09 12:15:40'),
(9, 'Julie', 'Dooley', 'julie@example.com', '2024-07-09 12:15:40');
...
('root', '[{\"db\":\"myapp\",\"table\":\"mails\"},{\"db\":\"myapp\",\"table\":\"mail_users\"},{\"db\":\"myapp\",\"table\":\"users\"},{\"db\":\"mailing_system\",\"table\":\"users\"},{\"db\":\"mailing_system\",\"table\":\"mails\"},{\"db\":\"myapp\",\"table\":\"notes\"},{\"db\":\"m3db_v2\",\"table\":\"users\"},{\"db\":\"m3db_v2\",\"table\":\"gmail_users\"},{\"db\":\"m3db_v2\",\"table\":\"verified_users\"},{\"db\":\"m3db\",\"table\":\"t_country\"}]');
...
('m3db', 't_city', 'city_name'),
('m3db', 't_country', 'country_name'),
('m3db_v2', 'gmail_users', 'uid'),
('m3db_v2', 'verified_users', 'uid'),
('myapp', 'mails', 'subject');
...
('root', 'm3db_v2', 'gmail_users', '{\"sorted_col\":\"`gmail_users`.`email` DESC\"}', '2024-07-15 12:59:06');
...
('root', '2024-07-19 08:32:46', '{\"Console\\/Mode\":\"show\",\"DefaultConnectionCollation\":\"utf8mb4_general_ci\",\"NavigationWidth\":258}');
...
USE `test`;
--
-- Database: `toursched_db`
--
CREATE DATABASE IF NOT EXISTS `toursched_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `toursched_db`;
...
--
-- AUTO_INCREMENT for table `t_date`
--
ALTER TABLE `t_date`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
